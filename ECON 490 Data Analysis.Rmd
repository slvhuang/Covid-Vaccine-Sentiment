...
```{r}
mod1 <- lm(admin_per_100k ~ sentiment + user_state,
           data = after_vac)
summary(mod1)
```
...
```{r}
mod2 <- lm(admin_per_100k ~  new_death + new_case + sentiment + user_state, 
           data = after_vac)
summary(mod2)
```

```{r}
mod3 <- lm(admin_per_100k ~  new_death*new_case + sentiment + user_state, 
           data = after_vac)
summary(mod3)
```
